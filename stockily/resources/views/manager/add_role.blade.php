  ...
  <body>
    <div class="left">
      ...
      <div class="left__btns">
        <div class="nav__btn nav__btn--2"><a href="">Continue</a></div>
        <div class="nav__btn nav__btn--2"><a href="manager_dashboard">back</a></div>
        <h3 class="btn--2">
            You already have a DataBase?  <a href="manager_dashboard"><span>Click Here !</span></a> 
            </h3>
      </div>
    </div>
    <div class="right">
